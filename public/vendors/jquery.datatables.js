...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *  @param {string} sClass Lessons to give the new TD cell
		...
		if ( aoColDefs )
		{
			...
			for ( i=aoColDefs.length-1 ; i>=0 ; i-- )
			{
				...
				for ( j=0, jLen=aTargets.length ; j<jLen ; j++ )
				{
					...
					{
						/* Lessons name matching on TH element */
	...
	DataTable.models.oColumn = {
		...
		/**
		 * Lessons to be applied to the header element when sorting on this column
		 *  @type string
		 *  @default null
		 */
		"sSortingClass": null,
	...
	DataTable.defaults.column = {
		...
		/**
		 * Lessons to give to each cell in this column.
		 *  @type string
		 *  @default <i>Empty string</i>
		 *
